...
if __name__ == "__main__":
    ...
    parser.add_argument("--image", type=str, default="raw/test_case/test_case0.jpg")
    parser.add_argument("--session", type=str, default="data_w(104,56)_or18_ppc(8, 8)_cpb(2, 2)_sgTrue_gmFalse_hnmTrue")
